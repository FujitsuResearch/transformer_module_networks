...
class CLEVRDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return (img, regions, img_info, spatials, image_mask, input_ids, segment_ids, input_mask, co_attention_mask, answer_id, question_id,)
    ...
    def tokenize(self, progs, max_length=36, padding_index=47):
