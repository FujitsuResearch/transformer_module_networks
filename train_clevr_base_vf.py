...
def main():
    ...
    parser.add_argument(
        "--use_bert",
        action="store_true",
        help="use BERT-BASE for initialization",
    )
    parser.add_argument(
    ...
    if args.use_bert:
        ...
        transformer = BaseTransformer.from_pretrained(bert_pretrained_model, config=config)
        print(f'use {bert_pretrained_model} for initialization')
