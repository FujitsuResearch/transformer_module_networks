...
from models.module_sm import TransformerModuleNet
from models.module_vf import TransformerModuleNetWithExtractor
from datasets.clevr_dataset_program_sm import CLEVRDataset
...
def main():
    ...
    parser.add_argument(
        "--func_map", type=str, default='', help="function map",
    )
